...
*/
$imgUrl = "../images/siswa/".$_POST['imgUrl'];
// original sizes
...
//    imagecopyresampled($final_image, $cropped_rotated_image, 0, 0, $imgX1, $imgY1, $cropW, $cropH, $cropW, $cropH);
	...
	$hapusFile1 = "../images/siswa/".$imgUrl;
	...
	$sql_query = "SELECT * FROM siswa WHERE peserta_didik_id = '".mysqli_escape_string($koneksi, $idp)."'";		
		...
		if(mysqli_num_rows($resultset)) {     
			...
			$flama=$ava['avatar'];
			$hapusFile = "../images/siswa/".$flama;
			if(file_exists($hapusFile)){
				unlink($hapusFile);
			};
			$sql_update = "UPDATE siswa set avatar='".mysqli_escape_string($koneksi,$nama_file.$type)."' WHERE peserta_didik_id = '".mysqli_escape_string($koneksi, $idp)."'";
