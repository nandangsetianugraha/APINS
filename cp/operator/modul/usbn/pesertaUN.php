...
while($s=$query->fetch_assoc()) {
	...
	$actionButton = '
		<a href="../../cetak/cetakKartu.php?idp='.$ids.'" class="btn btn-effect-ripple btn-xs btn-danger" type="button" target="_blank"><i class="fa fa-print"></i></a>
		';
	$output['data'][] = array(
		$nopes['nopes'],
		$nama['nis'],$nama['nisn'],$nama['nama'],$nama['tempat'].', '.TanggalIndo($nama['tanggal']),$nama['nama_ayah'],$nama['nama_ibu'],$actionButton
	);
