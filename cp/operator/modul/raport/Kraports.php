...
while($s=$query->fetch_assoc()) {
	...
	if($ada>0){
		$output['data'][] = array(
		$j['nama'],
		$n['nilai'],$n['predikat'],$n['deskripsi'].' <a class="btn btn-primary btn-xs" data-toggle="modal" data-target="#edit-raport" data-id="'.$idr.'" id="editRaport"><i class="fa fa-edit"></i></a>',
		$actionButton
		);
