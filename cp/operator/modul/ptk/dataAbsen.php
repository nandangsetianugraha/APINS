...
if($jmanual>0){
	...
	if($jijin>0){
		...
		$tombol='
		<button class="btn btn-effect-ripple btn-xs btn-danger" type="button" data-toggle="modal" data-ids="'.$ida.'" data-tgls="'.$hariini.'" data-target="#ijinmanual"><i class="fa fa-calendar-check-o"></i></button>
		<button class="btn btn-effect-ripple btn-xs btn-danger" type="button" data-toggle="modal" data-id="'.$ida.'" data-tgl="'.$hariini.'" data-target="#absenmanual"><i class="fa fa-share-square-o"></i></button>
	';
	};
}
