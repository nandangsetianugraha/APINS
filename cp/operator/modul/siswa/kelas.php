...
while ($row = $query->fetch_assoc()) {
	...
	$rmb=$row['rombel'];
	$actionButton = '
		<a href="../pages/edit-siswa.php?id='.$ids.'" class="btn btn-effect-ripple btn-xs btn-danger" type="button"><i class="fa fa-edit"></i></a>
		<button class="btn btn-effect-ripple btn-xs btn-danger" type="button" data-toggle="modal" data-target="#outMemberModal" onclick="outMember('.$row['id_rombel'].')"><i class="fa fa-trash"></i></button>
