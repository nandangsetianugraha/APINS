						...
						<div class="info-box">
							...
							<div class="info-box-content">
							  ...
							  <span class="info-box-number">
								<select id="idsiswa" class="form-control  selectsiswa" style="width: 100%;" name="idsiswa">
			...
			<div class="box">
				<div class="box-header">
					<div class="box-tools pull-right">
						<a href="upload/form.php" title="Tambah Beban" class="btn">
							<i class="fa fa-upload"></i> Tambah Beban
						</a>
					</div>
				</div>
