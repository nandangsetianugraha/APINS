				...
				<div class="box box-primary">
					<div class="box-header">
					  ...
					  <div class="box-tools pull-right">
						<button type="button" class="btn btn-box-tool" data-toggle="modal" data-target="#tambahKD" id="addKDModalBtn"><i class="fa fa-plus"></i> Pemetaan</button>
					  </div>
					</div>
					<div class="box-body">
			...
			<div class="col-lg-6 col-xs-12">
				<div class="box box-primary">
					<div class="box-header">
					  ...
					  <div class="box-tools pull-right">
						<button type="button" class="btn btn-box-tool" data-toggle="modal" data-target="#tambahKDk" id="addKDModalBtnk"><i class="fa fa-plus"></i> Pemetaan</button>
				      </div>
					</div>
					<div class="box-body">
              ...
              <form class="form" action="../modul/administrasi/tambahpeta.php" method="POST" id="createPetaForm">
                        <div class="modal-body">
							...
							<div class="form-group">
								...
								<select class="form-control" name="temaku" id="temaku" data-placeholder="Pilih Pembelajaran">
									<?php 
									for($i = 1; $i < 16; $i++) {
									?>
									<option value="<?=$i;?>">Pembelajaran <?=$i;?></option>
									<?php } ?>
								</select>
							</div>
							<?php }; ?>
