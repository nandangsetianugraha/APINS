					...
					<div class="col-lg-6 col-xs-6">
						<form class="form-horizontal" action="absensi.php" method="GET">
							...
							<div class="form-group">
								...
								?>
								<option value="<?=$nk['nama_rombel'];?>" <?php if($nk['nama_rombel']==$kelas){echo "selected";}; ?>>Kelas <?=$nk['nama_rombel'];?></option>
								<?php };?>
								</select>
							</div>
						</form>
				...
				<div class="row">
					<div class="col-lg-12 col-xs-12">
						<div class="box box-primary">
							...
							<div class="box-body">
								<form class="form-horizontal" action="../../cetak/cetakabsen.php" method="GET" id="cetakabsenForm">	
									<div class="form-group">
										<div class="col-sm-5">
