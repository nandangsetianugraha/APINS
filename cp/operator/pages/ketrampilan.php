		...
		<div class="box box-primary">
			<div class="box-header">
              <h3 class="box-title"><?php 
								...
								?>
								Penilaian Aspek Ketrampilan <?=$mpm['nama_mapel'];?> Kelas <?=$romb;?> <?php if(($ab>3 and $mpid==8) or ($ab>3 and $mpid==4) or ($ab>3 and $mpid==9) or ($ab>3 and $mpid==10) or ($ab>3 and $mpid==11)){ ?> Pembelajaran <?php }else{ ?> Tema <?php }; ?> <?=$tema;?></h3>
