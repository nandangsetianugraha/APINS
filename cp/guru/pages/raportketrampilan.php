    ...
    <section class="content">
		...
		<div class="row">
			...
			<div class="col-lg-12 col-xs-12">
				<div class="box">
					<div class="box-body">
						<a href="raportketrampilan.php" class="btn btn-social btn-bitbucket">
			...
			<div class="col-lg-12 col-xs-12">
				...
				<div class="box box-primary">
					<div class="box-header">
					  <h3 class="box-title">Generate Raport Ketrampilan <?=$mpm['nama_mapel'];?> Kelas <?=$romb;?></h3>
					</div>
					<div class="box-body">
			  ...
			  <div class="modal-dialog">
				<div class="modal-content">
				  <div class="modal-header">
					...
					<h4 class="modal-title">Edit Raport Ketrampilan</h4>
				  </div>
			...
			<div class="col-lg-12 col-xs-12">
				<div class="box box-primary">
					<div class="box-header">
					  <h3 class="box-title">Generate Nilai Raport Ketrampilan Kelas <?=$romb;?></h3>
					  <div class="box-tools pull-right">
						<?php 
			if($level==96 or $level==95 or $level==94){ //guru pai
			?>
			
						<form class="form" action="raportketrampilan.php" method="GET">
...
<script>
	...
	$(document).ready(function() {
		Raportku = $("#Raportku").DataTable({
			"searching": false,
			"ajax": "../modul/raport/Kraports.php?kelas=<?=$romb;?>&tapel=<?=$tpl_aktif;?>&smt=<?=$smt;?>&mp=<?=$mpid;?>",
			"order": []
		});
		$(document).on('click', '#getRaport', function(e){
			...
			$.ajax({
				url: '../modul/raport/GKraports.php',
				type: 'POST',
	...
	$(document).ready(function() {
		RaportTable = $("#RaportTable").DataTable({
			"searching": false,
			"ajax": "../modul/raport/Kraport.php?kelas=<?=$romb;?>&tapel=<?=$tpl_aktif;?>&smt=<?=$smt;?>",
			"order": []
		});
	});
	<?php };?>
