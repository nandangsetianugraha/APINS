	...
	$(document).ready(function() {
		...
		$('#kd').change(function(){
			...
			$.ajax({
				...
				beforeSend: function()
				{	
					$("#nilaiHarian").html('<i class="fa fa-spinner fa-pulse fa-fw"></i> Memuat Data Nilai.......');
				},
				success: function (data) {
		...
		$('#kd').change(function(){
			...
			$.ajax({
				...
				beforeSend: function()
				{	
					$("#nilaiHarian").html('<i class="fa fa-spinner fa-pulse fa-fw"></i> Loading ...');
				},
				success: function (data) {
