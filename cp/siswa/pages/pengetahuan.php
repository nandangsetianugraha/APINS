...
<body class="hold-transition skin-blue sidebar-mini">    
    ...
    <section class="content">
		<div class="box box-primary">
			<div class="box-body">
				<form role="form" action="../pages/pengetahuan.php" method="GET">
				<div class="row">
		...
		<div class="box box-primary">
			<div class="box-header">
              <h3 class="box-title"><?php 
								...
								?>
								Penilaian Aspek Pengetahuan <?=$mpm['nama_mapel'];?></h3>
...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		nilaiHarian = $("#nilaiHarian").DataTable({
				"searching": false,
				"ajax": "../modul/dataHarian.php?kelas=<?=$ab;?>&tapel=<?=$tapel;?>&smt=<?=$smt;?>&mp=<?=$mpid;?>&peta=3&pdid=<?=$idku;?>",
				"order": []
			});
	});
</script>
