...
<body class="hold-transition skin-blue sidebar-mini">    
    ...
    <section class="content">
		<div class="box box-primary">
			<div class="box-body">
				<form role="form" action="../pages/ketrampilan.php" method="GET">
				<div class="row">
		...
		<div class="box box-primary">
			<div class="box-header">
              <h3 class="box-title"><?php 
								...
								?>
								Penilaian Aspek Ketrampilan <?=$mpm['nama_mapel'];?></h3>
			...
			<div class="box-body">
				<div class="row">
					...
					<div class="col-lg-3 col-xs-12">
						...
						<div class="box-body">
						  Aspek Ketrampilan diukur berdasarkan Nilai Praktek, Proyek, dan Portofolio.
						</div>
						<!-- /.box-body -->
...
<script type="text/javascript" language="javascript" class="init">
	...
	$(document).ready(function() {
		nilaiHarian = $("#nilaiHarian").DataTable({
				"searching": false,
				"ajax": "../modul/dataKet.php?kelas=<?=$ab;?>&tapel=<?=$tapel;?>&smt=<?=$smt;?>&mp=<?=$mpid;?>&peta=4&pdid=<?=$idku;?>",
				"order": []
			});
	});
</script>
