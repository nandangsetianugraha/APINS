...
if($level==96){ //guru pai
	...
	$cekkdp=mysqli_num_rows(mysqli_query($koneksi, "select * from kd where kelas='$ab' and aspek=3 and mapel='$mpid'"));
	$cekkdk=mysqli_num_rows(mysqli_query($koneksi, "select * from kd where kelas='$ab' and aspek=4 and mapel='$mpid'"));
	$jumkd=$cekkdp+$cekkdk;
	if($cekkkmp==$jumkd){
		$boleh=true;
	}else{
