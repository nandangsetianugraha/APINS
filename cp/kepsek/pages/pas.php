    ...
    <section class="content">
		...
		<div class="box box-primary">
			<div class="box-header">
              <h3 class="box-title">Penilaian Akhir Semester/Tahun</h3>
	...
	$(document).ready(function() {
		...
		$('#kd').change(function(){
			...
			$.ajax({
				...
				beforeSend: function()
				{	
					$("#nilaiPTS").html('<center><img src="facebook-1.gif"><br/>Memuat Data Nilai Tengah Semester....Harap Bersabar.</center>');
				},
				success: function (data) {
