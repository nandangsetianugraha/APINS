			...
			<div class="col-md-3">
				...
				<div class="box box-primary">
					<div class="box-body box-profile">
						<img class="profile-user-img img-responsive img-circle" id="profile_picture" src="../../../images/user-default.png" alt="User profile picture">
					  ...
					  <a href="./siswa.php?status=1&tapel=<?=$tapel;?>" class="btn btn-primary btn-block"><b>Kembali</b></a>
					</div>
					<!-- /.box-body -->
				</div>
				  <!-- /.box -->
