...
<html lang="en">
	...
	<body>
		...
		<nav class="navbar navbar-inverse" role="navigation">
			<div class="container-fluid">
				<div class="navbar-header">
					<a class="navbar-brand" href="#" style="color: white;"><b>Import Data Transaksi</b></a>
				</div>
		...
		<div style="padding: 0 15px;">
			...
			<a href="../tabungan.php" class="btn btn-danger pull-right">
				...
				if($ext == "xlsx"){
					...
					foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
						...
						if($numrow > 1){
							...
							if(empty($nis) or empty($nama) or empty($jenis_kelamin)){
