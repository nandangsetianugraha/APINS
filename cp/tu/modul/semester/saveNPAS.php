...
$kd=$_REQUEST['kd'];
$cek="select * from nats where id_pd='$pdid' AND kelas='$kelas' AND smt='$smt' AND tapel='$tapel' AND mapel='$mapel' and kd='$kd'";
...
if ($ada>0){
	...
	$sql = "INSERT INTO nats VALUES('','$pdid','$kelas','$smt','$tapel','$mapel','$kd','$nilai')";
};
